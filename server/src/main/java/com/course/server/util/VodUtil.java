...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        request.setCateId(1000294734L);
        request.setTemplateGroupId("356567c94d1ec333dea7647406758f6a");
    ...
    public static void main(String[] argv) {
        ...
        //您的AccessKeySecret
        String accessKeySecret = "odWTHmZjOAxeD63FuOm2KRpHkx5SZP";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "C:\\Users\\Administrator\\Desktop\\1\\1.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
