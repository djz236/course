    ...
    <div class="row">
      ...
      <div v-for="course in courses" class="col-md-4">
        <div class="thumbnail search-thumbnail">
          <img v-show="!course.image" class="media-object" src="https://www.baidu.com/img/flexible/logo/pc/result.png"/>
          ...
          <div class="caption">
            ...
            <div v-for="teacher in teachers.filter(t=>{return t.id===course.teacherId})" class="profile-activity clearfix">
              <div>
                <img v-show="!teacher.image" class="pull-left" src="http://www.2qqtouxiang.com/pic/TX9484_03.jpg">
