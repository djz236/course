    ...
    <table id="simple-table" class="table  table-bordered table-hover">
      ...
      <td>
        <div class="hidden-sm hidden-xs btn-group">
          <button v-on:click="edit(courseuser)" class="btn btn-xs btn-info">
            <i class="ace-icon fa fa-pencil bigger-120"></i>
          </button>
          <button v-on:click="del(courseuser.id)" class="btn btn-xs btn-danger">
          ...
          <div class="modal-body">
            <form class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input v-model="courseuser.password" class="form-control">
                </div>
              </div>
            </form>
          </div>
...
<script>
  ...
  export default {
    ...
    mounted: function() {
      ...
      _this.list(1);
      // sidebar激活样式方法一
      // this.$parent.activeSidebar("system-courseuser-sidebar");
